...
{
    //
    // Your driver's DeviceID is ASCOM.DagorFans.Switch
    //
    ...
    /// ASCOM Switch Driver for DagorFans.
    /// </summary>
    [Guid("a2c66d40-2882-4f49-8bba-216e5c969416")]
    ...
    public class Switch : ISwitchV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.DagorFans.Switch";
        ...
        public double GetSwitchValue(short id)
        {
            ...
            // Client API returns int value - convert value to double
            int value = client.getFanState(id + 1);
        ...
        public void SetSwitchValue(short id, double value)
        {
            ...
            // Client API expects int value - convert value to int
            client.setFanState(id + 1, Convert.ToInt32(value));
        }
