...
//
// ASCOM Focuser driver for DagorFocus
//
...
namespace ASCOM.DagorFocus
{
    ...
    //
    // Your driver's DeviceID is ASCOM.DagorFocus.Focuser
    //
    // The Guid attribute sets the CLSID for ASCOM.DagorFocus.Focuser
    // The ClassInterface/None addribute prevents an empty interface called
    // _DagorFocus from being created and used as the [default] interface
    //
    ...
    /// ASCOM Focuser Driver for DagorFocus.
    /// </summary>
    [Guid("1490b928-7d50-4dd0-8079-7118ccfe6818")]
    ...
    public class Focuser : IFocuserV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.DagorFocus.Focuser";
        ...
        private FocusApiClient client;

        /// <summary>
        /// Initializes a new instance of the <see cref="DagorFocus"/> class.
        ...
        public void Halt()
        {
            ...
            // TODO implement Halt, first need a "/halt/" API endpoint
        ...
        public bool IsMoving
        {
            get
            {
                ...
                {
                    LogMessage("IsMoving Get, error: ", ex.ToString());
                    throw new NotConnectedException();
                }
                LogMessage("IsMoving Get, idle: ", false.ToString());
                return !isIdle;
            }
        }
