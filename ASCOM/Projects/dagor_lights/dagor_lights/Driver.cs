...
//
// ASCOM Switch driver for dagor_lights
//
...
namespace ASCOM.dagor_lights
{
    //
    // Your driver's DeviceID is ASCOM.dagor_lights.Switch
    //
    // The Guid attribute sets the CLSID for ASCOM.dagor_lights.Switch
    // The ClassInterface/None addribute prevents an empty interface called
    // _dagor_lights from being created and used as the [default] interface
    //
    ...
    /// ASCOM Switch Driver for dagor_lights.
    /// </summary>
    [Guid("37897be0-6730-45b9-9cfc-0e5edb48e78d")]
    ...
    public class Switch : ISwitchV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.dagor_lights.Switch";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Switch Driver for dagor_lights.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="dagor_lights"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public Switch()
        {
            tl = new TraceLogger("", "dagor_lights");
