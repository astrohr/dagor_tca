...
// --------------------------------------------------------------------------------
//
// ASCOM Switch driver for DAGOR
//
// Description:	Driver for switches on Tican observatory. "Dagor" is the name of the main scope. 
//              Currently implemented switches:
//                  1 - dome reflector lights, first of two sets
//                  2 - dome reflector lights, second of two sets
//
// Implements:	ASCOM Switch interface version: 0.1.0
// Author:		(FHR) Fran Hrzenjak <fran@astro.hr>
//
// Edit Log:
//
// Date			Who	Vers	Description
// -----------	---	-----	-------------------------------------------------------
// 2015-01-17	FHR	0.1.0	Initial edit, created from ASCOM driver template
// --------------------------------------------------------------------------------
//
...
{
    //
    // This driver's DeviceID is ASCOM.DAGOR.Switch
    //
    // The Guid attribute sets the CLSID for ASCOM.DAGOR.Switch
    ...
    /// ASCOM Switch Driver for DAGOR.
    /// </summary>
    [Guid("c3a237a0-aab3-458d-b835-26d9b0b659d2")]
    ...
    public class Switch : ISwitchV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.DAGOR.Switch";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Switch Driver for Tican observatory.";

        // Constants used for Profile persistence:
        internal static string serverHostProfileName = "Server Hostname";
        internal static string serverHostDefault = "tcs";
        ...
        public bool Connected
        {
            ...
            set
            {
                ...
                {
                    connectedState = true;
                    tl.LogMessage("Connected Set", "Connecting to server at " + serverHost);
                    // TODO verify device respondes
                }
                else
                {
                    connectedState = false;
                    tl.LogMessage("Connected Set", "Disconnecting from port " + serverHost);
                    // nothing else to do with this device
                }
            }
        }
        ...
        public string GetSwitchDescription(short id)
        {
            ...
            {
                case 1:
                    description = "Dome lights, first of two sets";
                    break;
                case 2:
                    description = "Dome lights, second of two sets";
                    break;
                default:
        ...
        public bool GetSwitch(short id)
        {
            ...
            if (id <= 2)
            {
                return this.CommandBool(string.Format("switch {0}", id));
            }
