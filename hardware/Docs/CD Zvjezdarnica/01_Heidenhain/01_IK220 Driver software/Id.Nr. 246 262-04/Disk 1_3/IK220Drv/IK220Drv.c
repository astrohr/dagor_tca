/*
	...
	History:		-													Version  0.08	ES	24.06.1999
					- Time out in IOCTL_BURSTRAM						Version  0.15	ES	29.07.1999
					- Save bus number in DEVICE_EXTENSION				Version  0.16	ES	30.07.1999
					- Change in resource descripton						Version  0.17	ES  04.08.1999
					- Version 1.0 release								Version  1.00   ES  04.08.1999
					------------------------------------------------------------------------------------------
					- Version 2.0 release								Version  2.00   ES  19.10.1999
					------------------------------------------------------------------------------------------
					- Version 3.0 release								Version  3.00   ES  13.06.2000
					------------------------------------------------------------------------------------------
					- Version 4.0 release								Version  4.00   ES  29.10.2001
					------------------------------------------------------------------------------------------
