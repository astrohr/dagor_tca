...
type
  Tpara_display = class(TForm)
    ...
    procedure resolution1Exit(Sender: TObject);
...
(*************************************************)
 ...
 begin
  ...
  (* Resolution *)
  r:=cnt^.count[axis]^.display.resolut;
  str(r:6:6,s);
...
(* Resolution                                    *)
(*************************************************)
procedure Tpara_display.resolution1Exit(Sender: TObject);
var
  s      : string;
  r      : real;
  code   : integer;
...
begin
  ...
  val(s,r,code);
  cnt^.count[axis]^.display.resolut:=r;
  rebuild_all;
end;
(*************************************************)
(* Digits                                        *)
