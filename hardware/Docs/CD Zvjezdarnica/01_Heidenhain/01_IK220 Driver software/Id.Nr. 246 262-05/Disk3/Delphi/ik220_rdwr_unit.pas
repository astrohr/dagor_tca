...
begin
  ...
  cnt^.count[axis]^.yde_c.off0:=off0;
  cnt^.count[axis]^.yde_c.off9:=off9;
  cnt^.count[axis]^.yde_c.pha0:=pha0;
  cnt^.count[axis]^.yde_c.pha1:=pha1;
  cnt^.count[axis]^.yde_c.sym0:=sym0;
  cnt^.count[axis]^.yde_c.sym1:=sym1;
end;
(******************************************************************)
procedure cnt_get_corr_e(axis:word);
var
...
begin
  ...
  cnt^.count[axis]^.yde_e.off0:=off0;
  cnt^.count[axis]^.yde_e.off9:=off9;
  cnt^.count[axis]^.yde_e.pha0:=pha0;
  cnt^.count[axis]^.yde_e.pha1:=pha1;
  cnt^.count[axis]^.yde_e.sym0:=sym0;
  cnt^.count[axis]^.yde_e.sym1:=sym1;
end;
{******************************************************************)
(* Ref-Status                                                     *)
(******************************************************************}
