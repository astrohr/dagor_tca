...
(*                                                                *)
(******************************************************************)
procedure Calc_reg_mm(periode:real;
                      incr:double;
                      var wert:double);
begin
  (* Calculate mm -> periode in um *)
  wert:=incr*periode/1000;
end;
(******************************************************************)
(*                                                                *)
(******************************************************************)
procedure Calc_reg_degree(periode:real;
                          incr:double;
                          strichzahl:longint;
                          var wert:double);
begin
...
begin
  (* Display Resolution *)
  resolution:=resolut/1000000; (* Eingabe nm : wert 1 ergibt millionstel mm *)
  if resolution<0.000000000001 then resolution:=0.000000000001;
