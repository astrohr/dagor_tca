...
#define IK220_IOCTL_LATCHIS		(IK220_IOCTL_IDX+10) 
#define IK220_IOCTL_LATCHES		(IK220_IOCTL_IDX+11) 
...
#define IOCTL_LATCHIS	CTL_CODE (FILE_DEVICE_IK220,	\
								  IK220_IOCTL_LATCHIS,	\
								  METHOD_BUFFERED,		\
								  FILE_ANY_ACCESS )

#define IOCTL_LATCHES	CTL_CODE (FILE_DEVICE_IK220,	\
								  IK220_IOCTL_LATCHES,	\
								  METHOD_BUFFERED,		\
								  FILE_ANY_ACCESS )
