 ...
 *
 * "@(#) $Id: ik220.c,v 1.2 2009/05/03 03:02:12 ecdowney Exp $"
 *
 * who      when     what
 * -------- -------- ------------------------------
...
MODULE_DESCRIPTION ("Heidenhain IK220 driver");
   ...
   MODULE_LICENSE ("LOOK AT FILE : Describe.txt");
#endif
...
static int __devinit ik220_init_board (struct pci_dev *pdev)
{
   ...
   pci_request_regions(pdev, "ik220");
...
static int __init ik220_init_module (void)
{
   ...
   // change seems to be required for 2.6.13 -> 2.6.22
